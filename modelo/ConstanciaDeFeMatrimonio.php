...
class ConstanciaDeMatrimonio extends ModeloBase
{
    ...
    public function toArrayParaConstanciaPDF()
    {
        ...
        $datos_constancia['municipio_contrayente_1'] = Validador::estaVacio($this->contrayente_1->getMunicipio(), 'Lugar de nacimiento (Municipio)');
        $datos_constancia['municipio_contrayente_2'] = Validador::estaVacio($this->contrayente_2->getMunicipio(), 'Lugar de nacimiento (Municipio)');
