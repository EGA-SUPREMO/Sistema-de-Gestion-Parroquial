...
class matrimoniocontrolador
{
    ...
    public function matrimonio()
    {
        ...
        $nombreContrayente1 = $_POST["nombreContrayente1"];
        $naturalContrayente1 = $_POST["naturalContrayente1"];
        $nombreContrayente2 = $_POST["nombreContrayente2"];
        $naturalContrayente2 = $_POST["naturalContrayente2"];
        ...
        $nombreSacerdoteMatrimonio = $_POST["nombreSacerdoteMatrimonio"];


        $diaExpedicion = $_POST["diaExpedicion"];
        $mesExpedicion = $_POST["mesExpedicion"];
        $anoExpedicion = $_POST["anoExpedicion"];
        $nombreAdministradorParroquial = $_POST["nombreAdministradorParroquial"];
