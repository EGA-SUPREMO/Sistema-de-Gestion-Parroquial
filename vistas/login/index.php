                ...
                <section class="card shadow-lg rounded-4">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="d-flex justify-content-end mb-4">
                            <a href="?c=administradores&a=Registro" class="btn btn-primary btn-lg rounded-pill shadow-sm">
                                Añadir Nuevo Administrador
                            </a>
                        </div>

                        <?php if (empty($administradores)): // Cambiado de $feligreses a $administradores 
                        ?>
