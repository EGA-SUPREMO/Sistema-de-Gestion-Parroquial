...
<div class="container mt-5">
    <div class="card shadow-sm">
        ...
        <h1 class="mb-0">Registrar Feligres</h1>
    </header>
        </div>
        <div class="card-body">
            <?php
            ...
            <form action="index.php?c=feligreses&a=Guardar" method="post" autocomplete="off">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="cedula" name="cedula" class="form-control" placeholder="Ingrese el número de cédula (sin puntos)" pattern="\d{4,10}" maxlength="10" required>
                </div>
                ...
                <div class="text-left">
                    ...
                    <button type="submit" class="btn btn-primary">Guardar Feligrés</button>
                </div>
            </form>
        </div>
    </div>
